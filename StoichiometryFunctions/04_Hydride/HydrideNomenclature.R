...
HydrideNomenclature <- function(input_atomic_number1 = NULL, 
                              input_valence1 = NULL,
  ...
  # Part 0: Necessary Participants
  {
    ...
    # Chemestry Formule
    chemestry_formule_resolution <- input_hydride_resolution[nrow(input_latex), c(9:12)]
  ...
  # Part 1: Other Necessary Items
  {
    ...
    # This position is only for Hydrure
    my_pos <- 4
...
} # End Function HydrideNomenclature***
...
# 
# 
#                                 HydrideNomenclature(input_atomic_number1 = input_atomic_number1,
#                                                   input_valence1 = input_valence1,
