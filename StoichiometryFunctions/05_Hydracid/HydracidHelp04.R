...
# Hydracid Helper
HydracidHelp04 <-function(input_atomic_number1 = NULL, 
                          input_valence1 = NULL, 
  ...
  ###
    ...
    {
      ###
      my_4 <- as.numeric(as.character(as.vector(input_hydracid_resolution[4, c("Coef2")])))
      my_5 <- as.numeric(as.character(as.vector(input_hydracid_resolution[5, c("Coef2")])))
    ...
    {
      ###
      my_5 <- as.numeric(as.character(as.vector(input_hydracid_resolution[5, c("Coef1")])))
      my_6 <- as.numeric(as.character(as.vector(input_hydracid_resolution[6, c("Coef1")])))
    ...
    {
      ###
      my_6 <- as.numeric(as.character(as.vector(input_hydracid_resolution[6, c("Coef1", "Coef2", "Coef3")])))
      my_7 <- as.numeric(as.character(as.vector(input_hydracid_resolution[7, c("Coef1", "Coef2", "Coef3")])))
