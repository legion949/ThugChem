...
# Salt Helper
SaltHelp04 <-function(input_atomic_number1 = NULL, 
                         input_valence1 = NULL, 
  ...
  ###
    ...
    # Step 3: New subindex for Salt?
    {
      ###
      my_2 <- as.numeric(as.character(as.vector(input_salt_resolution[2, c("Sub5", "Sub6")])))
      my_3 <- as.numeric(as.character(as.vector(input_salt_resolution[3, c("Sub5", "Sub6")])))
      ...
      new_help04[3] <- gsub("_sub5_", my_3[1], new_help04[3])
      new_help04[3] <- gsub("_sub6_", my_3[2], new_help04[3])      
      remove(my_2, my_3)
      ###  
    } # End Step 3
    #######################################
    ...
    # Step 4: Subindex simplificated?
    {
      ###
      my_3 <- as.numeric(as.character(as.vector(input_salt_resolution[3, c("Sub5", "Sub6")])))
      my_4 <- as.numeric(as.character(as.vector(input_salt_resolution[4, c("Sub5", "Sub6")])))
    ...
    {
      ###
      my_4 <- as.numeric(as.character(as.vector(input_salt_resolution[4, c("Coef1")])))
      my_5 <- as.numeric(as.character(as.vector(input_salt_resolution[5, c("Coef1")])))
    ...
    {
      ###
      my_5 <- as.numeric(as.character(as.vector(input_salt_resolution[5, c("Coef2")])))
      my_6 <- as.numeric(as.character(as.vector(input_salt_resolution[6, c("Coef2")])))
    ...
    {
      ###
      my_6 <- as.numeric(as.character(as.vector(input_salt_resolution[6, c("Coef4")])))
      my_7 <- as.numeric(as.character(as.vector(input_salt_resolution[7, c("Coef4")])))
    ...
    {
      ###
      my_8 <- as.numeric(as.character(as.vector(input_salt_resolution[8, c("Coef1", "Coef2", "Coef3", "Coef4")])))
      my_9 <- as.numeric(as.character(as.vector(input_salt_resolution[9, c("Coef1", "Coef2", "Coef3", "Coef4")])))
