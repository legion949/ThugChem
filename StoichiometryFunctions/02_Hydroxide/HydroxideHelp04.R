...
# Hydroxide Helper
HydroxideHelp04 <-function(input_atomic_number1 = NULL, input_valence1 = NULL, 
  ...
  ###
    ...
    # Step 4: New coefficient 3?
    {
      ###
      my_3 <- as.numeric(as.character(as.vector(input_hydroxide_resolution[3, c("Coef3")])))
      my_4 <- as.numeric(as.character(as.vector(input_hydroxide_resolution[4, c("Coef3")])))
      
      if (!identical(my_3, my_4)){ 

        new_help04[4] <- my_YES[4] 
        new_help04[4] <- gsub("_coef3_", my_4, new_help04[4])
    ...
    {
      ###
      my_4 <- as.numeric(as.character(as.vector(input_hydroxide_resolution[4, c("Coef2")])))
      my_5 <- as.numeric(as.character(as.vector(input_hydroxide_resolution[5, c("Coef2")])))
    ...
    {
      ###
      my_6 <- as.numeric(as.character(as.vector(input_hydroxide_resolution[6, c("Coef1", "Coef2", "Coef3")])))
      my_7 <- as.numeric(as.character(as.vector(input_hydroxide_resolution[7, c("Coef1", "Coef2", "Coef3")])))
...
# 
# 
# input_hydroxide_help04 <- HydroxideHelp04(input_atomic_number1 = input_atomic_number1,
#                                         input_valence1 = input_valence1,
#                                         input_internal_language = "en",
#                                         input_external_language = input_external_language,
#                                         input_PeriodicTable = input_PeriodicTable,
