  ...
  # Part 1: Resolution
  {
    ...
    if ("Oxide" == input_family) {
      ...
      if ("Hydroxide" == input_family) {
        ...
        # Hydroxide!
        general_help04 <- HydroxideLaTeX(input_atomic_number1 = input_atomic_number1,
                                                input_valence1 = input_valence1,
                                                input_internal_language = "en",
                                                input_external_language = input_external_language,
                                                input_PeriodicTable = input_PeriodicTable)
        ...
        if ("Oxacid" == input_family) {
          ...
          # Oxacid
          general_help04 <- OxacidLaTeX(input_atomic_number1 = input_atomic_number1,
                                               input_valence1 = input_valence1,
                                               input_internal_language = "en",
                                               input_external_language = input_external_language,
                                               input_PeriodicTable = input_PeriodicTable)
          ...
          if ("Hydride" == input_family) {
            ...
            # Hydride
            general_help04 <- HydrideLaTeX(input_atomic_number1 = input_atomic_number1,
                                                  input_valence1 = input_valence1,
                                                  input_internal_language = "en",
                                                  input_external_language = input_external_language,
                                                  input_PeriodicTable = input_PeriodicTable)
            ...
            if ("Hydracid" == input_family) {
              ...
              # Hydradic
              general_help04 <- HydracidLaTeX(input_atomic_number1 = input_atomic_number1,
                                                     input_valence1 = input_valence1,
                                                     input_internal_language = "en",
                                                     input_external_language = input_external_language,
                                                     input_PeriodicTable = input_PeriodicTable)
              ...
              if ("Oxosalt" == input_family) {
                ...
                # Oxosalt
                general_help04 <- OxosaltLaTeX(input_atomic_number1 = input_atomic_number1,
                                                      input_valence1 = input_valence1,
                ...
                if ("Salt" == input_family) {
                  ...
                  # Salt
                  general_help04 <- SaltLaTeX(input_atomic_number1 = input_atomic_number1,
                                                     input_valence1 = input_valence1,
                                                     input_atomic_number2 = input_atomic_number2,
                                                     input_valence2 = input_valence2,
                                                     input_internal_language = "en",
                  ...
                  if(sum(my_family == input_family) == 0) {
                    ...
                    # Emergency!
                    general_help04 <- matrix_emergency_exit
                  }
    ###
