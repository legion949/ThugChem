...
# LaTeX 08: General
GeneralLaTeX <- function(input_atomic_number1 = NULL, input_valence1 = NULL,
  ...
  # Part 1: Resolution
  {
    ...
    if ("Oxide" == input_family) {
      ...
      # Oxide!
      general_resolution <- OxideLaTeX(input_atomic_number1 = input_atomic_number1,
      ...
      if ("Hydroxide" == input_family) {
        ...
        # Hydroxide!
        general_resolution <- HydroxideLaTeX(input_atomic_number1 = input_atomic_number1,
                                                input_valence1 = input_valence1,
                                                input_internal_language = "en",
                                                input_external_language = input_external_language,
                                                input_PeriodicTable = input_PeriodicTable)
        ...
        if ("Oxacid" == input_family) {
          ...
          # Oxacid
          general_resolution <- OxacidLaTeX(input_atomic_number1 = input_atomic_number1,
                                               input_valence1 = input_valence1,
                                               input_internal_language = "en",
                                               input_external_language = input_external_language,
                                               input_PeriodicTable = input_PeriodicTable)
          ...
          if ("Hydride" == input_family) {
            ...
            # Hydride
            general_resolution <- HydrideLaTeX(input_atomic_number1 = input_atomic_number1,
                                                  input_valence1 = input_valence1,
                                                  input_internal_language = "en",
                                                  input_external_language = input_external_language,
                                                  input_PeriodicTable = input_PeriodicTable)
            ...
            if ("Hydracid" == input_family) {
              ...
              # Hydradic
              general_resolution <- HydracidLaTeX(input_atomic_number1 = input_atomic_number1,
                                                     input_valence1 = input_valence1,
                                                     input_internal_language = "en",
                                                     input_external_language = input_external_language,
                                                     input_PeriodicTable = input_PeriodicTable)
              ...
              if ("Oxosalt" == input_family) {
                ...
                # Oxosalt
                general_resolution <- OxosaltLaTeX(input_atomic_number1 = input_atomic_number1,
                                                      input_valence1 = input_valence1,
                ...
                if ("Salt" == input_family) {
                  ...
                  # Salt
                  general_resolution <- SaltLaTeX(input_atomic_number1 = input_atomic_number1,
                                                     input_valence1 = input_valence1,
                                                     input_atomic_number2 = input_atomic_number2,
                                                     input_valence2 = input_valence2,
                                                     input_internal_language = "en",
...
# 
# 
# input_general_resolution <- GeneralLaTeX(input_atomic_number1 = input_atomic_number1,
#                                          input_valence1 = input_valence1,
#                                          input_atomic_number2 = input_atomic_number2,
#                                          input_valence2 = input_valence2,
#                                          input_family = "Oxide",
